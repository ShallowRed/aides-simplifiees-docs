...
Le passage d'un simulateur mono-aide à un outil multi-aides ne consiste pas simplement à additionner des modèles ; c'est un changement d'échelle qui introduit une complexité exponentielle. Il s'agit de faire cohabiter des logiques administratives hétérogènes (CAF, Région, État) au sein d'un parcours unifié pour l'usager.
