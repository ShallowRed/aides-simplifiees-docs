...
La modélisation logique ne dicte pas l'interface, mais elle la contraint. Pour concevoir le parcours, il faut ordonner les questions selon une stratégie d'entonnoir :
