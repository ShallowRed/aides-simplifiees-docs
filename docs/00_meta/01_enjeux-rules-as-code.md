...
> **Modéliser les aides**, c’est ouiller notre capacité collective à comprendre ce que l’on finance, à mesurer l’impact réel des politiques publiques et à garantir l’égalité d’accès aux droits.

### 1. Un besoin d’équité et de lisibilité

Une part significative des personnes éligibles à une aide publique ne la perçoivent pas, non par choix, mais faute d’information ou de compréhension du dispositif.
...
- **Lisibilité vs exhaustivité** : comment représenter une règle complexe sans perdre en clarté ?
- **Réutilisabilité vs spécificité locale** : comment créer des modèles communs tout en respectant les particularismes ?
- **Innovation vs sécurité juridique** : comment innover sans compromettre la validité juridique des règles ?
